...
public class ApplicationRunner {
    ...
    public static void main(String[] args) {
        ...
        String[][] wordBoard = setWordBoard(words, boardSize); // function returns multi array of indexes containing the hidden words

        String[][] placeholderBoard = setTempBoard(boardSize); // function that returns the multi array of indexes containing the placeholders
    ...
    public static String[][] setWordBoard(ArrayList words, int size) {
        ...
        int position = 0; // separate incrementer that gets each word and assigned to wordBoard in the nested for loop
                ...
                if ((c1 >= 0 && c1 < boardSize) && (r1 >= 0 && r1 < boardSize)) { // check if user input is out of bounds. if false, display error message and ask for input again
                    ...
                    if ((r2 >= 0 && r2 < boardSize) && (c2 >= 0 && c2 < boardSize)) { // check if user input is out of bounds. if false, display error message and ask for input again
                        ...
                        if (inputValid) { // if both inputs are valid i.e. user did not choose an already revealed word, then increment guesses and check if matching.
                            ...
                            if (firstWord.equals(secondWord)) { // if matching, draw new board with both inputs permanently revealed and increment matchingWords.
